...
export default function WorklistReviewSummary({ workflowTransactionId }: WorklistReviewSummaryProps) {
    ...
    const [workflowTransactionStepId, setWorkflowTransactionStepId] = useState<number | null>(null)
        ...
        <>
                                ...
                                <Box className="p-4 bg-gray-50 rounded-lg border border-gray-100 flex flex-col gap-2 h-full relative">
                                    <Box className="flex items-center justify-between mb-1">
                                        ...
                                        <Box className="flex gap-2 items-center">
                                            ...
                                            <Button onClick={() => setOpenDelegateModal(true, approver.workflowTransactionStepId)} size="small" className='h-7' variant="outlined">Delegate</Button>
                                        </Box>
                                    </Box>
            ...
            {canDelegate && (
                <WorklistDelegateDialog
                    ...
                    workflowTransactionId={workflowTransactionId || 0}
                    workflowTransactionStepId={workflowTransactionStepId || 0}
                />
            )}
        </>
