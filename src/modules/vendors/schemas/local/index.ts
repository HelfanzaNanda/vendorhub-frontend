      ...
      datatableConfigs: [
        {
          ...
          columns: [
            ...
            { id: 'subCategory', header: 'Sub Category', accessorKey: 'subCategory.name' },
            { id: 'subCategoryItem', header: 'Sub Category Item', accessorKey: 'subCategoryItem.name' },
            { id: 'customerReferencesCount', header: 'Customer References', accessorKey: 'customerReferencesCount' },
